                                                ...
                                                if(rs.next()){
                                                    rs.beforeFirst();
                                                        while(rs.next()){
                                                            ...
                                                            out.println("</td><td>" + "<a href='accept.jsp?rid=" + rs.getInt("requestID") + "&vID=" + rs.getInt("request.vehicleID")+    "' class='btn btn-success'><i class='material-icons'>done</i><a href='reject.jsp?rid=" + rs.getInt("requestID") +"&vID=" + rs.getInt("request.vehicleID")+ "' class='btn btn-success'><i class='material-icons'>close</i>");
                                                            out.println("</td></tr>");
                                                        }
                                                }else{
